...
(require 'data-devopicons            "./data/data-devopicons")
(require 'data-file-icons            "./data/data-file-icons")
(require 'data-mfixx                 "./data/data-mfixx")
(require 'data-octicons              "./data/data-octicons")
(require 'data-vscode-codicons       "./data/data-vscode-codicons")
...
(defvar all-the-icons-extension-icon-alist
  '(
    ...
    ("eslintignore" all-the-icons-file-icons "eslint"               :face all-the-icons-purple)
    ("eslint"       all-the-icons-file-icons "eslint"               :face all-the-icons-lpurple)
    ("git"          all-the-icons-devopicons "git"                  :face all-the-icons-lred)
    ...
    ("gz"           all-the-icons-octicons "file-binary"            :face all-the-icons-lmaroon)
    ...
    ("dmg"          all-the-icons-octicons "tools"                  :face all-the-icons-lsilver)
    ("dll"          all-the-icons-octicons "gear"                   :face all-the-icons-silver)
    ("ds_store"     all-the-icons-octicons "gear"                   :face all-the-icons-silver)
    ;; Source Codes
    ...
    ("wasm"         all-the-icons-file-icons "wasm"                 :face all-the-icons-purple-alt)
    ("wat"          all-the-icons-file-icons "wasm"                 :face all-the-icons-purple-alt)
    ...
    ("cache"        all-the-icons-octicons "database"               :face all-the-icons-green)))
...
(defvar all-the-icons-mode-icon-alist
  '(
    ...
    (gnus-article-mode        all-the-icons-octicons "mail-read"          )
