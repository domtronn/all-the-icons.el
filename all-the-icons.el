...
(defvar all-the-icons-extension-icon-alist
  '(
    ...
    ("bzl"             file-icons "bazel"                :face all-the-icons-dgreen    )
...
(defvar all-the-icons-regexp-icon-alist
  '(
    ...
    ("^\\.bazel"               file-icons "bazel"            :face all-the-icons-dgreen  )
...
(defvar all-the-icons-mode-icon-alist
  '(
    ...
    (bazelrc-mode                      file-icons "bazel"                 :face all-the-icons-dgreen    )
    (bazeliskrc-mode                   file-icons "bazel"                 :face all-the-icons-dgreen    )
    (bazel-build-mode                  file-icons "bazel"                 :face all-the-icons-dgreen    )
    (bazelignore-mode                  file-icons "bazel"                 :face all-the-icons-dgreen    )
    (bazel-module-mode                 file-icons "bazel"                 :face all-the-icons-dgreen    )
    (bazel-starlark-mode               file-icons "bazel"                 :face all-the-icons-dgreen    )
    (bazel-workspace-mode              file-icons "bazel"                 :face all-the-icons-dgreen    )
