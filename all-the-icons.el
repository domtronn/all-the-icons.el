...
(defvar all-the-icons-extension-icon-alist
  '(
    ...
    ("cmake-cache"  all-the-icons-fileicon "cmake"            :face all-the-icons-red)
    ...
    ("crt"          all-the-icons-faicon "certificate"        :v-adjust 0.0 :face all-the-icons-yellow)
    ...
    ("p12"          all-the-icons-faicon "certificate"        :v-adjust 0.0 :face all-the-icons-yellow)
