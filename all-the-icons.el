...
(defvar all-the-icons-extension-icon-alist
  '(
    ...
    ("rs"           all-the-icons-alltheicon "rust"           :v-adjust -0.1 :height 1.1 :face all-the-icons-dorange)
    ("rlib"         all-the-icons-alltheicon "rust"           :v-adjust -0.1 :height 1.1 :face all-the-icons-dmaroon)
